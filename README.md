...
- **🌍 Region Correction** - Always join ur region. U can also use [RoLocate](https://greasyfork.org/en/scripts/523727-rolocate) to easily connect to the nearest server to your location.
